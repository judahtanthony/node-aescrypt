...
test.cb(
  'Encrypt-Decrypt: should get the same contents after decrypting then before encrypting',
  t => {
...
test.cb(
  'Encrypt-Decrypt: should be able to encrypt/decrypt large random files',
  t => {
